...
def main() -> None:
    ...
    parser.add_argument("--theme", default="mixed", choices=("mixed", "cute", "cool", "sarcastic", "dramatic", "love", "celebration", "work"))
    ...
    if args.format == "json":
        ...
        for index, item in enumerate(selected, 1):
            print(f"{index}. {item['id']} | {item['name_zh']} | {item['prompt']}")
